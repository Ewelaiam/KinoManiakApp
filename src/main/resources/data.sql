...
--     END IF;
    ...
    THEN
        insert into movie(id, title, age_restriction, director, duration, premier_date, description, posterurl)
        ...
        insert into movie(id, title, age_restriction, director, duration, premier_date, description, posterurl)
        values (21, ''Interstellar'', 12, ''Christopher Nolan'', 169, ''2022-08-24'', ''A team of explorers travel through a wormhole in space in an attempt to ensure humanity''''s survival.'', ''https://m.media-amazon.com/images/M/MV5BZjdkOTU3MDktN2IxOS00OGEyLWFmMjktY2FiMmZkNWIyODZiXkEyXkFqcGdeQXVyMTMxODk2OTU@._V1_UX67_CR0,0,67,98_AL_.jpg'');
        ...
        insert into movie(id, title, age_restriction, director, duration, premier_date, description, posterurl)
        values (27, ''Se7en'', 18, ''David Fincher'', 127, ''2022-12-11'', ''Two detectives, a rookie and a veteran, hunt a serial killer who uses the seven deadly sins as his motives.'', ''https://m.media-amazon.com/images/M/MV5BOTUwODM5MTctZjczMi00OTk4LTg3NWUtNmVhMTAzNTNjYjcyXkEyXkFqcGdeQXVyNjU0OTQ0OTY@._V1_UX67_CR0,0,67,98_AL_.jpg'');
        ...
        insert into movie(id, title, age_restriction, director, duration, premier_date, description, posterurl)
        values (35, ''The Intouchables'', 12, ''Olivier Nakache'', 112, ''2022-04-10'', ''After he becomes a quadriplegic from a paragliding accident, an aristocrat hires a young man from the projects to be his caregiver.'', ''https://m.media-amazon.com/images/M/MV5BMTYxNDA3MDQwNl5BMl5BanBnXkFtZTcwNTU4Mzc1Nw@@._V1_UX67_CR0,0,67,98_AL_.jpg'');
        ...
        insert into movie(id, title, age_restriction, director, duration, premier_date, description, posterurl)
        values (37, ''The Departed'', 18, ''Martin Scorsese'', 151, ''2022-11-30'', ''An undercover cop and a mole in the police attempt to identify each other while infiltrating an Irish gang in South Boston.'', ''https://m.media-amazon.com/images/M/MV5BMTI1MTY2OTIxNV5BMl5BanBnXkFtZTYwNjQ4NjY3._V1_UX67_CR0,0,67,98_AL_.jpg'');
        ...
        insert into movie(id, title, age_restriction, director, duration, premier_date, description, posterurl)
        values (38, ''The Pianist'', 12, ''Roman Polanski'', 150, ''2022-04-22'', ''A Polish Jewish musician struggles to survive the destruction of the Warsaw ghetto of World War II.'', ''https://m.media-amazon.com/images/M/MV5BOWRiZDIxZjktMTA1NC00MDQ2LWEzMjUtMTliZmY3NjQ3ODJiXkEyXkFqcGdeQXVyNjU0OTQ0OTY@._V1_UY98_CR2,0,67,98_AL_.jpg'');
        ...
        insert into movie(id, title, age_restriction, director, duration, premier_date, description, posterurl)
        values (46, ''Hotaru no haka'', 12, ''Isao Takahata'', 89, ''2022-01-07'', ''A young boy and his little sister struggle to survive in Japan during World War II.'', ''https://m.media-amazon.com/images/M/MV5BZmY2NjUzNDQtNTgxNC00M2Q4LTljOWQtMjNjNDBjNWUxNmJlXkEyXkFqcGdeQXVyNTA4NzY1MzY@._V1_UX67_CR0,0,67,98_AL_.jpg'');
